...
public class CreateReport {
    ...
    public void startReport() {
        ...
        htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") +"/test-output/MonefyTestReport.html");
        ...
        htmlReporter.config().setDocumentTitle("Appium Test Automation Report");
        htmlReporter.config().setReportName("Monefy Appium Test Report");
